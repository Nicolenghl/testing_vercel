...
// Contract address
export const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CONTRACT_ADDRESS || '0x2b241fD51483517bc0142b5a17628783aFbeD9fA';
...
// Minimal ABI for better compatibility across contract versions
export const MINIMAL_CONTRACT_ABI = [
    ...
    // Core contract state variables (optional - may not exist in all versions)
    {
        "inputs": [],
        "name": "dishCounter",
        "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }],
